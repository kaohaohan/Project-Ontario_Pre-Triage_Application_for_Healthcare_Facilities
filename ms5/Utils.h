...
public:
  ...
  ///  hour x 60 + min. This value will be the intial starting time for
  ...
  /// <summary>
  /// If not in debugging mode, returns the current minute value of the system
  /// hour
  ///  and minute. If debugging is active it will first return the value of
  ///  m_testMins then adds the following values in these intervals
  ///  (3,5,9,20,30) to simulate passage of time.
  /// </summary>
  ...
  /// <returns> &gt;0 if s1 &gt; s2  OR  &lt;0 if s1 &lt; s2 OR 0 if s1 =
  /// s2</returns>
...
extern bool debug;
/// <summary>
/// making seneca::U "Utils" object global to all the files which include
/// "Utils.h"
/// </summary>
extern Utils U;
